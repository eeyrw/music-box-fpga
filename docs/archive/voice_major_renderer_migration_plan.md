...
> **Archived:** This replacement has landed. This file preserves the original
> migration goals and acceptance criteria; it does not describe the current
> implementation. See [`../design/renderer/overview.md`](../design/renderer/overview.md)
> and [`../design/renderer/pipeline.md`](../design/renderer/pipeline.md).
