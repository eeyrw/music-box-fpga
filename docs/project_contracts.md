...
| SPI voice completion log | [`design/transport/spi_voice_status.md`](design/transport/spi_voice_status.md) | `fpga/common/rtl/spi_completion_log.sv`, `fpga/common/rtl/spi_register_bridge.sv`, `mcu/fpga_spi_transport.c` |
