module wavetable_register_fabric #(
  ...
  function automatic logic is_common_status_address(input logic [15:0] address);
    unique case (address)
      ...
      REG_MEM_RESPONSE_COUNT, REG_DIAGNOSTIC_CONTROL,
      REG_PIPELINE_LATENCY_MAX, REG_AUDIO_FIFO_DIAGNOSTICS,
      REG_AUDIO_LEAD, REG_COMMAND_ERROR_COUNT,
      REG_STALE_GENERATION_COUNT, REG_RENDER_SESSION_EPOCH,
