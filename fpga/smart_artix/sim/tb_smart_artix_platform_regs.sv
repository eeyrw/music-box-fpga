...
/* verilator lint_on BLKSEQ */
  ...
  initial begin
    ...
    platform_status.sd_card_present = 1'b1;
    platform_status.sd_high_speed_active = 1'b1;
    ...
    platform_status.sd_retry_count = 8'h56;
    platform_status.sd_recovery_error_code = 4'hb;
