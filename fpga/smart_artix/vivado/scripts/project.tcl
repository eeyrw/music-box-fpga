...
foreach required_env [list SYNTH_NUM_VOICES SYNTH_BLOCK_WORK_ENTRY_COUNT SYNTH_BLOCK_JOB_ENTRY_COUNT SYNTH_MAX_BLOCK_FRAMES] {
...
set synth_block_job_entry_count $::env(SYNTH_BLOCK_JOB_ENTRY_COUNT)
