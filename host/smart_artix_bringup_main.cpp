...
constexpr uint16_t kVersion = 0x3000;
constexpr uint16_t kSystemStatus = 0x3010;
constexpr uint16_t kDebugEventFlags = 0x3014;
constexpr uint16_t kAudioStatus = 0x3018;
constexpr uint16_t kRenderStatus = 0x301c;
constexpr uint16_t kMemoryStatus = 0x3020;
constexpr uint16_t kUnderrunCount = 0x3024;
constexpr uint16_t kSampleDropCount = 0x3028;
constexpr uint16_t kRenderDeadlineMissCount = 0x302c;
constexpr uint16_t kMemHitCount = 0x3030;
constexpr uint16_t kMemMissCount = 0x3034;
constexpr uint16_t kMemResponseCount = 0x3038;
constexpr uint16_t kPlatformStatus = 0x3040;
constexpr uint16_t kPlatformErrors = 0x3044;
constexpr uint16_t kPlatformBytesLoaded = 0x3048;
constexpr uint16_t kPlatformSf2Size = 0x3050;
constexpr uint16_t kPlatformCurrentLba = 0x3058;
constexpr uint16_t kPlatformDdrStatus = 0x305c;
...
constexpr uint32_t kPlatformDebugPresent = 1u << 0;
constexpr uint32_t kPlatformErrorPresent = 1u << 1;
constexpr uint32_t kPlatformDdrCalibrated = 1u << 2;
constexpr uint32_t kPlatformDdrUiReset = 1u << 3;
constexpr uint32_t kPlatformSdInitialized = 1u << 4;
constexpr uint32_t kPlatformAssetLoaded = 1u << 5;
...
constexpr uint32_t kDdrDebugStatusPresent = 1u << 0;
