...
typedef struct {
    ...
    uint32_t completion_events;
    uint32_t completion_reclaims;
    uint32_t completion_reclaims_before_release;
    uint32_t completion_reclaims_after_release;
    uint32_t completion_minimum_reclaim_age_ms;
    uint32_t completion_generation_mismatches;
    uint32_t completion_free_mismatches;
    uint32_t completion_failures;
    uint32_t completion_overflows;
    uint32_t completion_state_errors;
    uint32_t completion_reason_counts[3];
