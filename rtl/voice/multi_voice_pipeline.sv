module multi_voice_pipeline #(
  ...
  logic signed [FILTER_COEFF_WIDTH-1:0] cfg_filter_b0;
  logic signed [FILTER_COEFF_WIDTH-1:0] cfg_filter_b1;
  logic signed [FILTER_COEFF_WIDTH-1:0] cfg_filter_b2;
  logic signed [FILTER_COEFF_WIDTH-1:0] cfg_filter_a1;
  logic signed [FILTER_COEFF_WIDTH-1:0] cfg_filter_a2;
  ...
  logic signed [FILTER_COEFF_WIDTH-1:0] current_filter_b0;
  logic signed [FILTER_COEFF_WIDTH-1:0] current_filter_b1;
  logic signed [FILTER_COEFF_WIDTH-1:0] current_filter_b2;
  logic signed [FILTER_COEFF_WIDTH-1:0] current_filter_a1;
  logic signed [FILTER_COEFF_WIDTH-1:0] current_filter_a2;
