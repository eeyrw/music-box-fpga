...
void ddr3_bin_read_line8(int handle, std::uint64_t word_address,
                         std::uint32_t* words_1_0, std::uint32_t* words_3_2,
                         std::uint32_t* words_5_4, std::uint32_t* words_7_6);
