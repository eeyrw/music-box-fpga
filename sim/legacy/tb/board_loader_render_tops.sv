module board_loader_render_tops #(
  ...
  input  logic                      core_cmd_stream_valid,
  input  logic [31:0]               core_cmd_stream_data,
  output logic                      core_cmd_stream_ready,
  ...
  synth_pkg::cache_diagnostics_t core_cache_diagnostics;
  synth_pkg::render_timing_diagnostics_t core_render_diagnostics;
  synth_pkg::voice_pipeline_diagnostics_t core_voice_diagnostics;
  ...
  assign core_mem_response_trace_pulse =
      core_cache_diagnostics.response_trace_pulse;
  assign core_mem_response_trace_latency =
      core_cache_diagnostics.response_trace_latency;
  ...
  wavetable_cached_render_core #(
    ...
    .cmd_stream_valid(core_cmd_stream_valid),
    .cmd_stream_data(core_cmd_stream_data),
    .cmd_stream_ready(core_cmd_stream_ready),
    ...
    .cache_diagnostics(core_cache_diagnostics),
    .render_diagnostics(core_render_diagnostics),
    .voice_diagnostics(core_voice_diagnostics)
  );
...
/* verilator lint_on UNUSEDSIGNAL */
  assign unused_loader_status = loader_sd_transfer_clock_ready |
                                (|core_cache_diagnostics) |
                                (|core_voice_diagnostics) |
                                (|core_render_diagnostics);
endmodule
