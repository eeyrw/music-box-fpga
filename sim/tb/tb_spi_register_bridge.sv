module tb_spi_register_bridge;
  ...
  initial begin
    ...
    expect_read(reg_voice_addr(1, REG_OFF_COMMIT), 32'h0000_0000);
    expect_read(reg_voice_addr(1, REG_OFF_FILTER_COMMIT), 32'h0000_0000);
    write_expect(reg_voice_addr(1, REG_OFF_CONTROL), 32'hffff_ffff, REG_CONTROL_ENABLE_MASK);
    ...
    write_expect(reg_voice_addr(1, REG_OFF_REGION_MODE), 32'hffff_ffff, REG_REGION_MODE_MASK);
    write_expect(reg_voice_addr(1, REG_OFF_FILTER_CONTROL), 32'hffff_ffff, REG_FILTER_CONTROL_ENABLE_MASK);
    write_expect(reg_voice_addr(1, REG_OFF_FILTER_B0), 32'h1111_2222, 32'h1111_2222);
    write_expect(reg_voice_addr(1, REG_OFF_FILTER_B1), 32'h3333_4444, 32'h3333_4444);
    write_expect(reg_voice_addr(1, REG_OFF_FILTER_B2), 32'h5555_6666, 32'h5555_6666);
    write_expect(reg_voice_addr(1, REG_OFF_FILTER_A1), 32'h7777_8888, 32'h7777_8888);
    write_expect(reg_voice_addr(1, REG_OFF_FILTER_A2), 32'h9999_aaaa, 32'h9999_aaaa);
    ...
    spi_write_word(reg_voice_addr(0, REG_OFF_FILTER_B0), 32'h0800_0000);
    spi_write_word(reg_voice_addr(0, REG_OFF_REGION_MODE), 32'h0000_0000);
    ...
    expect_read(reg_voice_addr(0, REG_OFF_FILTER_B0), 32'h0800_0000);
    spi_write_word(reg_voice_addr(0, REG_OFF_COMMIT), REG_COMMIT_APPLY_MASK);
